...
int main()
{
    ...
    cout<<"Array Is : ";
    for(int i=2;i>=0;i--)                        //printing Array
    {
        cout<<var[i]<<" ";
    }
    cout<<endl;
    
    for(int i=2;i>=0;i--)                        //assignning the add to pointer
    {
        ptr=&var[2];
    }
    cout<<endl;
    
    for(int i=2;i>=0;i--)                        //print the values
    {       
        cout<<*ptr<<" ";
        ptr--;                                  //arithatic opearator for pointer array
    }
    ...
    for(int i=2;i>=0;i--)                        //print the adddress of values
    {       
        cout<<ptr<<" ";
        ptr--;
    }
